...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT(
            ...
            KC_Z, KC_Q, KC_J, KC_K, KC_X,                                           KC_B, KC_M, KC_W, KC_V, KC_Z,
                    ____, MO(MOUS),                                                                ____, ____, 
                                KC_BSPC, MO(SYMB),                                          KC_SPC,
                                  MO(NUM),                                                  MO(NAV), 
                           KC_DEL, KC_ESC,                                                   KC_ENT, KC_TAB),
	[NAV] = LAYOUT(
            ____, ____, ____, ____, ____,                                           ____, ____, ____, ____, ____, 
            KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_ENT,                             KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, ____,
            ____, KC_HOME, KC_PGDN, KC_PGUP, KC_END,                                  ____, ____, ____, ____, ____,  
                    ____, ____,                                                                 ____, ____, 
                                ____,____,                                             ____,
                                    MO(FUNC),                                            KC_TRNS,
                              ____, ____,                                            ____, ____),
	...
	[MEDI] = LAYOUT(
            ...
            ____, DT_DOWN, DT_UP, ____, ____,                               ____, ____, ____, ____, ____, 
                    ____, ____,                                                    ____, ____, 
                                KC_TRNS,KC_TRNS,                                     ____, 
                                ____,                                              ____, 
                                ____, ____,                                   ____, ____),
	[MOUS] = LAYOUT(
            ____, ____, ____, ____, ____,                                    ____, ____, ____, ____, ____, 
           ____, ____, ____, ____, ____,                                    ____, KC_MS_BTN1, KC_MS_BTN2, ____, ____, 
