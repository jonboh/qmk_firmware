...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NAV] = LAYOUT(
	            ...
	            ____, ____, ____, ____, ____,                                           KC_HOME, KC_PGDN, KC_PGUP, KC_END, ____,
                        ____, MO(NUM),                                             KC_TRNS, ____,
                        ____, KC_BSPC,                                                   KC_ESC,KC_SPC,
                        KC_TAB,    KC_DEL,                                                       KC_ENT),
	[SYMB] = LAYOUT(
	            ...
	            KC_CIRC, KC_SLSH, KC_ASTR, KC_BSLS, KC_AT,              KC_TILD, CW_TOGG, KC_LCBR, KC_RCBR,KC_EXLM,
                        MO(MOUSL), ____,                                             ____, MO(MOUSR),
	...
	[MOUSR] = LAYOUT(
	            ____, ____, ____, ____, ____,                                    ____, ____, ____, ____, ____,
	            KC_RGUI, KC_RALT,KC_RCTL ,KC_RSFT, ____,                       ____, KC_MS_BTN1, KC_MS_BTN2, MOUSE_TRACK_SCROLL, KC_MS_BTN3,
	               ____, ____, ____, ____, ____,                                ____, ____, ____, ____, ____,
